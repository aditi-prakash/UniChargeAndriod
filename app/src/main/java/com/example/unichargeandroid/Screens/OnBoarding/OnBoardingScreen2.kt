...
fun OnBoardingScreen2(
    ...
    Column(
            ...
            Image(
                painter = painterResource(
                    id = if (isSystemInDarkTheme()) {
                        ...
                        R.drawable.ob2_light
                    }
                ),
                contentDescription = "EV charging reservation and check-in",
                modifier = Modifier
                    .fillMaxSize(),
        ...
        Column(
            ...
            // Subtitle
            Text(
                text = "Get instant updates, monitor usage in real-time, and keep track of your EV charging with ease.",
                fontSize = 16.sp,
            ...
            Row(
                ...
                // Active indicator (second screen)
                Box(
                    modifier = Modifier
                        .width(32.dp)
                        .height(6.dp)
